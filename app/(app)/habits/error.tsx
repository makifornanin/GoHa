...
/** Error boundary for the Habits route. Never a blank panel: explain and retry. */
export default function HabitsError({
  ...
  return (
    <div className="card-shadow flex flex-col items-center justify-center rounded-xl border border-outline-variant bg-surface-container-lowest px-6 py-16 text-center">
      ...
      <h2 className="text-headline-md text-on-surface">We couldn&apos;t load your habits</h2>
