...
/** Error boundary for the Focus route. Never a blank panel: explain and retry. */
export default function FocusError({
  ...
  useEffect(() => {
    console.error("Focus route error", error);
  }, [error]);
  ...
  return (
    <div className="card-shadow flex flex-col items-center justify-center rounded-xl border border-outline-variant bg-surface-container-lowest px-6 py-16 text-center">
      ...
      <h2 className="text-headline-md text-on-surface">We couldn&apos;t load Focus</h2>
      <p className="mt-2 max-w-md text-body-md text-on-surface-variant">
        Something went wrong reaching the server. Your saved sessions are safe. Please try again.
      </p>
