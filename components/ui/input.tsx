...
const DATE_LIKE =
  ...
  "[&::-webkit-datetime-edit-month-field:focus]:bg-blue [&::-webkit-datetime-edit-month-field:focus]:text-white " +
  "[&::-webkit-datetime-edit-day-field:focus]:bg-blue [&::-webkit-datetime-edit-day-field:focus]:text-white " +
  "[&::-webkit-datetime-edit-year-field:focus]:bg-blue [&::-webkit-datetime-edit-year-field:focus]:text-white " +
  "[&::-webkit-datetime-edit-hour-field:focus]:bg-blue [&::-webkit-datetime-edit-hour-field:focus]:text-white " +
  "[&::-webkit-datetime-edit-minute-field:focus]:bg-blue [&::-webkit-datetime-edit-minute-field:focus]:text-white " +
  "[&::-webkit-datetime-edit-ampm-field:focus]:bg-blue [&::-webkit-datetime-edit-ampm-field:focus]:text-white " +
